...
! FORCINGINFO = 'forcinginfo.'//TRIM(MBASIN_ID)//'.txt' # FORCINGINFO defined in fuse_file_manager is not overwritten
...
FNAME_NETCDF = TRIM(OUTPUT_PATH)//'urs_modrun_'//TRIM(MBASIN_ID)//'_'//TRIM(SMODL%MNAME)//'_'//&
